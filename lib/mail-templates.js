...
export function monthlyReviewReply(data) {
  const { name = '', company = '', industry = '', revenue = '', message = '' } = data;
  return {
    subject: '初回ヒアリングのご予約を受け付けました ─ 九十九アドバイザリー',
    html: `
      <div style="background:#fafaf8;max-width:600px;margin:0 auto;font-family:sans-serif;">
        <div style="background:#1b2e4b;padding:24px 32px;">
          <p style="color:#b8963e;font-size:11px;font-weight:bold;letter-spacing:.14em;margin:0 0 6px;">CPA ADVISORY</p>
          <p style="color:#ffffff;font-size:16px;font-weight:bold;margin:0;">月次経営レビュー ─ 初回ヒアリング受付確認</p>
        </div>
        <div style="background:#ffffff;padding:32px;">
          <p style="font-size:16px;font-weight:bold;margin:0 0 16px;">${name} 様</p>
          <p style="margin:0 0 8px;">初回ヒアリングのご予約をいただきありがとうございます。</p>
          <p style="margin:0 0 24px;">内容を確認のうえ、2営業日以内にご連絡いたします。</p>
          <div style="background:#f6f1e8;padding:20px 24px;border-radius:4px;margin:0 0 24px;">
            <p style="font-size:12px;font-weight:bold;color:#b8963e;letter-spacing:.1em;margin:0 0 12px;">いただいた情報</p>
            <table style="width:100%;border-collapse:collapse;font-size:13px;">
              <tr><td style="padding:4px 0;color:#57534e;width:80px;">会社名</td><td style="padding:4px 0;">${company}</td></tr>
              <tr><td style="padding:4px 0;color:#57534e;">業種</td><td style="padding:4px 0;">${industry}</td></tr>
              <tr><td style="padding:4px 0;color:#57534e;">売上規模</td><td style="padding:4px 0;">${revenue}</td></tr>
              ${message ? `<tr><td style="padding:4px 0;color:#57534e;vertical-align:top;">ご相談内容</td><td style="padding:4px 0;white-space:pre-wrap;">${message}</td></tr>` : ''}
            </table>
          </div>
          <hr style="border:none;border-top:1px solid #eae8e3;margin:0 0 20px;" />
          <p style="font-size:14px;color:#57534e;margin:0 0 12px;">サービス詳細をあらためてご確認される場合:</p>
          <a href="https://99advisory.jp/monthly-review" style="background:#1b2e4b;color:#ffffff;padding:12px 24px;border-radius:4px;text-decoration:none;display:inline-block;font-size:14px;">月次経営レビューのページへ</a>
        </div>
        <div style="background:#f6f1e8;padding:20px 32px;font-size:13px;color:#57534e;">
          <p style="margin:0 0 4px;">九十九アドバイザリー</p>
          <p style="margin:0 0 4px;">info@99advisory.jp</p>
    ...
    `,
    text: `${name} 様\n\n初回ヒアリングのご予約をいただきありがとうございます。\n内容を確認のうえ、2営業日以内にご連絡いたします。\n\n【いただいた情報】\n会社名: ${company}\n業種: ${industry}\n売上規模: ${revenue}\n${message ? `ご相談内容: ${message}\n` : ''}\nサービス詳細: https://99advisory.jp/monthly-review\n\n九十九アドバイザリー\ninfo@99advisory.jp\nhttps://99advisory.jp\nこのメールは自動送信です。返信はお受けできません。`
  };
}
