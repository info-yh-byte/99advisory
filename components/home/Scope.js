  ...
  return (
    <section style={{ background: COLORS.bg, padding: "72px 20px" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        <div style={{ fontSize: 11, fontWeight: 800, color: COLORS.green, letterSpacing: 3, marginBottom: 10 }}>SCOPE</div>
        <h2 style={{ fontSize: "clamp(20px, 3.5vw, 28px)", fontWeight: 900, color: COLORS.text, marginBottom: 12 }}>こんなご相談に対応しています</h2>
        <p style={{ fontSize: 14, color: COLORS.sub, maxWidth: 560, margin: "0 auto" }}>年商規模や業種、相談テーマの例から、ご自身に近いケースかどうかを見ていただけます。</p>
      </div>
